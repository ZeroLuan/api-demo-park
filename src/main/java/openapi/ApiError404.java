...
public @interface ApiError404 {  // Quando você vê @interface, você não está criando uma "Interface comum" (como UsuarioDoc), você está criando uma Anotação Personalizada.
}
